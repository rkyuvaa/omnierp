...
def seed_email_templates(db: Session):
  ...
  <div style="text-align: center; margin: 28px 0 20px;">
    <a href="{action_url}" style="display: inline-block; background: linear-gradient(135deg, #1e40af 0%, #3b82f6 100%); color: #ffffff; text-decoration: none; padding: 13px 36px; border-radius: 8px; font-weight: 700; font-size: 15px; letter-spacing: 0.3px; box-shadow: 0 4px 12px rgba(30,64,175,0.35);">Respond Now →</a>
  </div>
  <p style="font-size: 12px; color: #94a3b8; text-align: center;">Or copy this link: {action_url}</p>
  <hr style="border: 0; border-top: 1px solid #e2e8f0; margin: 20px 0;" />
  <p style="font-size: 12px; color: #94a3b8; text-align: center; margin-bottom: 0;">This email was automatically generated by KIM ERP. Please do not reply directly to this mail.</p>
</div>"""
        },
  ...
  <div style="text-align: center; margin: 28px 0 20px;">
    <a href="{action_url}" style="display: inline-block; background: linear-gradient(135deg, #7c3aed 0%, #a855f7 100%); color: #ffffff; text-decoration: none; padding: 13px 36px; border-radius: 8px; font-weight: 700; font-size: 15px; letter-spacing: 0.3px; box-shadow: 0 4px 12px rgba(124,58,237,0.35);">Respond Now →</a>
  </div>
  <p style="font-size: 12px; color: #94a3b8; text-align: center;">Or copy this link: {action_url}</p>
  <hr style="border: 0; border-top: 1px solid #e2e8f0; margin: 20px 0;" />
  <p style="font-size: 12px; color: #94a3b8; text-align: center; margin-bottom: 0;">This email was automatically generated by KIM ERP. Please do not reply directly to this mail.</p>
